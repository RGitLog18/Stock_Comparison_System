...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/fontawesome.min.css">
     <link rel="icon" href="SYMBOL.jpg" type="image/x-icon">
...
<body>
    <div class="navbar">
        <div class="logo">
            ...
            <h1>Stock Lists for Intra-Day</h1>
     </div>        
        <div class="icons">
    ...
    <div class="body" style="background-image: url(/stockcompsys/images/logo4.PNG); width: 100%;">
        ...
        <!-- stocklist -->
            <div class="list">
                ...
                <div class="card card-hghlght demo-card">
                    <p>Meta Platforms Inc (Facebook)</p>
    ...
    <script>
        ...
        async function link() {
            try {
            let response = await fetch("./intracomparison.json");
